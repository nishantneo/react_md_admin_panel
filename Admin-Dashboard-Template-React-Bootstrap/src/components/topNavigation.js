            ...
            <MDBNavbar className="flexible-navbar" light expand="md" scrolling>
                ...
                <MDBCollapse isOpen = { this.state.collapse } navbar>
                    ...
                    <MDBNavbarNav right>
                        ...
                        <MDBNavItem>
                            <a className="border border-light rounded mr-1 nav-link Ripple-parent" rel="noopener noreferrer" href="" target="_blank"><MDBIcon fab icon="user" className="mr-2"/>Account</a>
                        </MDBNavItem>
                    </MDBNavbarNav>
                </MDBCollapse>
            </MDBNavbar>
